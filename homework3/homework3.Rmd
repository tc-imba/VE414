...
So
$$\begin{aligned}f_{Y=0\mid\mathbf{X}}&\propto f_{\mathbf{X}\mid Y=0}\cdot f_{Y=0}\\&=\frac{1}{3}f_{\mathbf{X}\mid Y=0}\\&=\frac{1}{3}(2\pi)^{-1}(\det\mathbf{\Sigma_g})^{-1/2}\exp\left[-\frac{1}{2}(\mathbf{x}-\mu_g)^T\mathbf{\Sigma_g}(\mathbf{x}-\mu_g)\right]\\&=\frac{1}{6\sqrt{3}\pi}\exp\left[\frac{1}{3}(-139-x_1^2+7x_2+16x_1+x_1x_2-x_2^2)\right],\end{aligned}$$
$$\begin{aligned}f_{Y=1\mid\mathbf{X}}&\propto f_{\mathbf{X}\mid Y=1}\cdot f_{Y=1}\\&=\frac{2}{3}f_{\mathbf{X}\mid Y=1}\\&=\frac{2}{3}(2\pi)^{-1}(\det\mathbf{\Sigma_t})^{-1/2}\exp\left[-\frac{1}{2}(\mathbf{x}-\mu_t)^T\mathbf{\Sigma_t}(\mathbf{x}-\mu_t)\right]\\&=\frac{1}{3\sqrt{23}\pi}\exp\left[\frac{1}{23}(-207-x_1^2+69x_2+x_1x_2-6x_2^2)\right].\end{aligned}$$
