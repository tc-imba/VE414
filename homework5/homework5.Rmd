...
The bivariate normal distribution is a standard bivariate normal distribution, where the means and variances of $y_1$ and $y_2$ is 0 and 1, and the correlation constant $\rho=0.3$. We can write
